  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Henpot - Your one-stop solution for event organization, user profile management, and performance assessments. Experience seamless event scheduling, reservation management, and usage tracking, all under one roof."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1511578314322-379afb476865?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxldmVudCUyMG1hbmFnZW1lbnR8ZW58MHx8fHwxNjk0MDAyNzU2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Henpot - Your one-stop solution for event organization, user profile management, and performance assessments. Experience seamless event scheduling, reservation management, and usage tracking, all under one roof.`}
            </Text>
            <Box
